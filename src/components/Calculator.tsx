      ...
      {(() => {
        ...
        return (
          ...
          >
            ...
            {/* Corto a propósito: el botón ahora ocupa la mitad, y «Pedir esta
                remesa por WhatsApp» se le partía en tres líneas. Lo que hace
                se entiende igual, y encima está debajo de la remesa que acaba
                de calcular. */}
            Pedir por WhatsApp
          </a>
        );
